...
describe('SavePictureController', () => {
  ...
  it('should return 400 if file is type is invalid', async () => {
  ...
  it('should not return 400 if file is type is valid', async () => {
  ...
  it('should return 400 if file is bigger than 5MB', async () => {
